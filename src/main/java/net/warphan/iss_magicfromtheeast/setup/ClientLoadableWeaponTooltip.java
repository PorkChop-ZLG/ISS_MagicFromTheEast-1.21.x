...
public class ClientLoadableWeaponTooltip implements ClientTooltipComponent {
    private static final ResourceLocation BACKGROUND_SPRITE = ResourceLocation.fromNamespaceAndPath(ISS_MagicFromTheEast.MOD_ID, "container/repeating_crossbow/background");
    ...
    @OnlyIn(Dist.CLIENT)
    static enum Texture {
        BLOCKED_SLOT(ResourceLocation.fromNamespaceAndPath(ISS_MagicFromTheEast.MOD_ID,"container/repeating_crossbow/blocked_slot"), 18, 20),
        SLOT(ResourceLocation.fromNamespaceAndPath(ISS_MagicFromTheEast.MOD_ID, "container/repeating_crossbow/slot"), 18, 20);
